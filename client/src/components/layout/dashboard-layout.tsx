      ...
      <header className="bg-white border-b border-neutral-200 shadow-sm sticky top-0 z-10">
        <div className="flex items-center justify-between px-4 py-3">
          <div className="flex items-center">
            ...
            <h1 className="text-xl font-semibold text-primary-800 lg:hidden">
              MedCore
            </h1>
          </div>
          ...
          <div className="flex items-center">
            <div className="relative mr-3">
              <Input
                type="text"
                placeholder="Search..."
                className="pl-9 pr-4 py-2 rounded-md border border-neutral-300 text-sm w-40 md:w-64"
              />
      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 lg:pl-64">
          <main className="py-6 px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl font-semibold text-neutral-800 mb-6">{title}</h2>
            {children}
          </main>
        </div>
      </div>
